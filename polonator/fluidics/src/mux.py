...
#--------------------------------------------------------------------------------------#
	...
	def discrete_valve4_close(self):
		...
		log.debug("---\t-\t--> MUX: switch 3-way discrete valve V4 to NC (ligase buffer)")
		mux_state_00[0] = 0
		mux_state = ([0,0,0,0,0,1,0,0])
		self.session.parse_read_string('m_dout[5]=' + str(mux_state[5]), '>')
		self.session.parse_read_string('m_dout[0]=' + str(mux_state_00[0]), '>')
	...
	def discrete_valve5_open(self):
		...
		log.debug("---\t-\t--> MUX: switch 3-way discrete valve V5 to NO (from V3 to FC)")
		mux_state_00[1] = 1
		mux_state = ([0,0,0,0,0,1,0,0])
		self.session.parse_read_string('m_dout[5]=' + str(mux_state[5]), '>')
		self.session.parse_read_string('m_dout[0]=' + str(mux_state_00[0]), '>')
	...
	def discrete_valve5_close(self):
		...
		log.debug("---\t-\t--> MUX: switch 3-way discrete valve V5 to NC (from mixer to FC)")
		mux_state_00[1] = 0
		mux_state = ([0,0,0,0,0,1,0,0])
		self.session.parse_read_string('m_dout[5]=' + str(mux_state[5]), '>')
		self.session.parse_read_string('m_dout[0]=' + str(mux_state_00[0]), '>')
	...
	def discrete_valve6_open(self):
		...
		log.debug("---\t-\t--> MUX: switch 3-way discrete valve V6 to NO (through FC 2)") 
		mux_state_00[2] = 1
		mux_state = ([0,0,0,0,0,1,0,0])
		self.session.parse_read_string('m_dout[5]=' + str(mux_state[5]), '>')
		self.session.parse_read_string('m_dout[0]=' + str(mux_state_00[0]), '>')
	...
	def discrete_valve6_close(self):
		...
		log.debug("---\t-\t--> MUX: switch 3-way discrete valve V6 to NC (through FC 1)")
		mux_state_00[2] = 0
		mux_state = ([0,0,0,0,0,1,0,0])
		self.session.parse_read_string('m_dout[5]=' + str(mux_state[5]), '>')
		self.session.parse_read_string('m_dout[0]=' + str(mux_state_00[0]), '>')
	...
	def set_to_temperature_control1(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to temperature controller 1")
	...
	def set_to_temperature_control2(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to temperature controller 2")
	...
	def set_to_reagent_block_cooler(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to reagent block cooler")
	...
	def set_to_rotary_valve1(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to ten port rotary valve V1")
	...
	def set_to_rotary_valve2(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to ten port rotary valve V2")
	...
	def set_to_rotary_valve3(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to ten port rotary valve V3")
	...
	def set_to_rotary_valve4(self):
		...
		log.debug("---\t-\t--> MUX: switch communication to ten port rotary valve V4")
