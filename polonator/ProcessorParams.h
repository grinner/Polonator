...
#define SAVE_FL_IMAGES 0 // save all raw fluorescent images; this is ALOT of data
  //#define BCDEBUG0 1  
...
#define AUTO_EXPOSURE_THRESHOLD 13000
#define AUTO_EXPOSURE_STARTING_GAIN 70
